...
const DEFAULT_COLUMNS: Omit<LibraryColumn, 'id' | 'order'>[] = [
  ...
  },
  {
    ...
    type: 'select',
    predefinedValues: ['Efficacy', 'Safety', 'QoL', 'Health Economics', 'Epidemiology', 'Real World Evidence'],
    isFilter: true,
    aiPrompt: 'Classify this article into one of the following categories: Efficacy, Safety, QoL, Health Economics, Epidemiology, Real World Evidence.',
    isDefault: true,
  },
  {
    name: 'Subcategory',
    description: 'Specific study subcategory',
    type: 'select',
    predefinedValues: ['RCT', 'Observational', 'Meta-Analysis', 'Systematic Review', 'Budget Impact', 'Cost-Effectiveness', 'PRO', 'Registry', 'Database Study'],
    isFilter: true,
    aiPrompt: 'Classify this article subcategory from: RCT, Observational, Meta-Analysis, Systematic Review, Budget Impact, Cost-Effectiveness, PRO, Registry, Database Study.',
    isDefault: true,
  },
  {
